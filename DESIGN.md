...
- [ ] Etap 1: Now Playing pełnoekranowy + mini-player z progress-track + shared element transition + `MediaSessionService` (odtwarzanie w tle, powiadomienie, słuchawki/Bluetooth) + prawdziwy font Inter + dynamiczny kolor z okładki (Palette API) + Haze/glassmorphism.
